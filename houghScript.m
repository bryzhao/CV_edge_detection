...
for i = 1:numel(imglist)
    ...
    % Im = Im'; % DEBUG, NEED TO INCLUDE THIS
    ...
    % lines = houghlines(Im>threshold, thetaScale, rhoScale, [rhos,thetas],'FillGap',5,'MinLength',2);
    % lines = houghlines(img, thetaScale, rhoScale, [rhos,thetas],'FillGap',5,'MinLength',2);
